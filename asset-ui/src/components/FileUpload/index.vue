  ...
  <div class="upload-file">
    ...
    >
      ...
      <div class="el-upload__tip" slot="tip" v-if="showTip">
        ...
        <template v-if="limit"> 数量不超过 <b style="color: #f56c6c">{{ limit }} 个</b> </template>
    ...
    <transition-group class="upload-file-list el-upload-list el-upload-list--text" name="el-fade-in-linear" tag="ul">
      <li :key="index" class="el-upload-list__item ele-upload-list__item-content" v-for="(file, index) in fileList">
        <el-link :href="`${baseUrl}${file.url}`" :underline="false" target="_blank" :class="classPrefix" :id="`${file.url}`" :name="`${file.name}`" >
