...
<script>
import { listDisposal, getDisposal, delDisposal, addDisposal, updateDisposal, exportDisposal } from "@/api/asset/disposal";
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != null) {
            updateDisposal(this.form).then(response => {
              this.$modal.msgSuccess("修改成功");
              this.open = false;
              this.getList();
            });
          } else {
            addDisposal(this.form).then(response => {
