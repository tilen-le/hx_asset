<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="jobList" @selection-change="handleSelectionChange">
      ...
      <el-table-column :label="$t('common_field.status')" align="center">
        <template slot-scope="scope">
          <el-switch
...
export default {
  ...
  methods: {
    ...
    handleStatusChange(row) {
      ...
      this.$modal.confirm(this.$t('common_field.tip'), this.$t('common_field.confirm'), this.$t('common_field.cancel'),'确认要"' + text + '""' + row.jobName + '"任务吗？').then(function() {
    ...
    /* 立即执行一次 */
    handleRun(row) {
      this.$modal.confirm(this.$t('common_field.tip'), this.$t('common_field.confirm'), this.$t('common_field.cancel'),'确认要立即执行一次"' + row.jobName + '"任务吗？').then(function() {
