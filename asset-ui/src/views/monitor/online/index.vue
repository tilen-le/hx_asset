<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column :label="$t('dept.name')" align="center" prop="deptName" />
...
export default {
  ...
  methods: {
    ...
    handleForceLogout(row) {
      this.$modal.confirm(this.$t('common_field.tip'), this.$t('common_field.confirm'), this.$t('common_field.cancel'),'是否确认强退名称为"' + row.userName + '"的数据项？').then(function() {
