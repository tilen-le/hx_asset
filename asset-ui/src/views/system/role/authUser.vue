...
export default {
  ...
  methods: {
    ...
    cancelAuthUser(row) {
      ...
      this.$modal.confirm(this.$t('common_field.tip'), this.$t('common_field.confirm'), this.$t('common_field.cancel'), this.$t('user.cancel_role_confirm')).then(function() {
    ...
    cancelAuthUserAll(row) {
      ...
      this.$modal.confirm(this.$t('common_field.tip'), this.$t('common_field.confirm'), this.$t('common_field.cancel'),this.$t('user.cancel_permission_confirm')).then(function() {
