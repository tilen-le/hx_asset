  ...
  <el-dialog title="导入表" :visible.sync="visible" width="800px" top="5vh" append-to-body>
    ...
    <el-row>
      <el-table @row-click="clickRow" ref="table" :data="dbTableList" @selection-change="handleSelectionChange" height="260px">
        ...
        <el-table-column prop="createTime" :label="$t('common_field.create_time')"></el-table-column>
        <el-table-column prop="updateTime" :label="$t('common_field.update_time')"></el-table-column>
      </el-table>
      <pagination
        v-show="total>0"
        :total="total"
    ...
    <div slot="footer" class="dialog-footer">
      <el-button type="primary" @click="handleImportTable">{{ $t('common_field.confirm') }}</el-button>
