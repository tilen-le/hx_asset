  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="tableList" @selection-change="handleSelectionChange">
      ...
      <el-table-column
        ...
        width="120"
      />
      <el-table-column :label="$t('common_field.create_time')" align="center" prop="createTime" width="160" />
      <el-table-column :label="$t('common_field.update_time')" align="center" prop="updateTime" width="160" />
...
export default {
  ...
  methods: {
    ...
    handleSynchDb(row) {
      ...
      this.$modal.confirm(this.$t('common_field.tip'), this.$t('common_field.confirm'), this.$t('common_field.cancel'),'确认要强制同步"' + tableName + '"表结构吗？').then(function() {
