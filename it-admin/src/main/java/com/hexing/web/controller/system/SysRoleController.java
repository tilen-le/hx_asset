...
import com.hexing.common.utils.DataUtils;
...
public class SysRoleController extends BaseController
{
    ...
    public AjaxResult add(@Validated @RequestBody SysRole role)
    {
        ...
        if (roleKey.indexOf(",") > 0) {
            return AjaxResult.error(MessageUtils.message("role.insert.fail.name"));
        }
        if (UserConstants.NOT_UNIQUE.equals(roleService.checkRoleNameUnique(role)))
        {
            return AjaxResult.error(MessageUtils.message("role.insert.fail.exist"));
        }
        else if (UserConstants.NOT_UNIQUE.equals(roleService.checkRoleKeyUnique(role)))
        {
            return AjaxResult.error(MessageUtils.message("role.insert.fail.permission"));
        }
