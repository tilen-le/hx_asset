...
public class SysUserController extends BaseController
{
    ...
    public AjaxResult add(@Validated @RequestBody SysUser user)
    {
        ...
        {
            return AjaxResult.error(MessageUtils.message("user.repeat.account"));
        }
    ...
    public AjaxResult remove(@PathVariable Long[] userIds)
    {
        ...
        {
            return error(MessageUtils.message("user.delete.error"));
        }
     ...
     * 根据角色code获取用户
     */
    @GetMapping("/getUserListByRoleCodes")
    public AjaxResult getUserListByRoleCodes(String roleCodes) {
        String[] roleCodesArray = roleCodes.split(",");
        if (ArrayUtils.isEmpty(roleCodesArray)) {
            return AjaxResult.error("roleCodes为空");
        }
        List<SysUser> userListByRoleCode = userService.getUserListByRoleCodes(roleCodesArray);
