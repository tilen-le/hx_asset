...
public interface SysUserMapper
{
    ...
    int updateDel(@Param("userId") Long userId, @Param("del")String del);

    List<SysUser> getUserListByUserNames(String[] userNames);

    List<SysUser> getOnOfficeUserList(@Param("parameter") String parameter);
