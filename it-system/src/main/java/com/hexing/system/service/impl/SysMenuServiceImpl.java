...
import com.hexing.system.domain.vo.MetaVo;
import com.hexing.system.domain.vo.RouterVo;
...
public class SysMenuServiceImpl implements ISysMenuService
{
    ...
    public List<SysMenu> selectMenuList(SysMenu menu, Long userId)
    {
        ...
        if (StringUtils.isBlank(language) || "en".equals(language)) {
            menuList.forEach(m -> m.setMenuName(m.getMenuEnName()));
        }
        return menuList;
    }
    ...
    public List<RouterVo> buildMenus(List<SysMenu> menus)
    {
        ...
        for (SysMenu menu : menus)
        {
            ...
            String language = MessageUtils.getLanguage();
            if (StringUtils.isBlank(language) || "en".equals(language)) {
                menu.setMenuName(menu.getMenuEnName());
            }
