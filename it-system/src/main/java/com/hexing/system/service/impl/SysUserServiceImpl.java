...
public class SysUserServiceImpl implements ISysUserService {
    ...
    private static final String ININT_PASSWORD = "hx.123";
    ...
    public void syncDepartmentUserList() {
        ...
        for (OdoCodeDTO odoUser : odoUserList) {
            ...
            if (Objects.isNull(userDO)) {
                ...
                sysUser.setPassword(SecurityUtils.encryptPassword(ININT_PASSWORD));
     ...
     */
    @Override
    public SysDept getCompanyByUserName(String userName) {
        ...
        while (dept.getParentId() != 0L) {
            dept = deptMapper.selectDeptById(dept.getParentId());
        }
        return dept;
    }
